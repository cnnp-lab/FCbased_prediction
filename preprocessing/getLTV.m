function LTV = getLTV(FCmatrix, H)
...
% number of preceding sessions available
nSesAvail =  (size(FCmatrix, 2) -2 )/2;

% get the minimum between H and nSesAvail
H = min([H nSesAvail]);
